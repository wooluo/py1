...
def get_films_sorted(url):
    ...
    films_set = soup.findAll('a', classmethod='ulink')  # list of tags "a" with attribute "class=ulink"

    for film in films_set:
        film_dic = {}
        # 提取地址
        film_href = "http://www.dy2018.com" + film['ulink']
        #film_herf = "http://www.ygdy8.net" + film['ulink']
        # 打开地址
        ...
        # 提取电影title及下载地址
        title_all = film_soup.findAll('div', classmethod='title_all')
